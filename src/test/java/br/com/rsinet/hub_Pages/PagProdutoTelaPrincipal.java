...
public class PagProdutoTelaPrincipal {
	...
	/*
	 * @FindBy(how = How.ID, using = "tabletsImg") private WebElement
	 * campoClicarTablet;
	 * 
	 * @FindBy(how = How.ID, using = "18") private WebElement campoEscolherTablet;
	 * 
	 * @FindBy(how = How.XPATH, using =
	 * "\"//*[@id=\\\"productProperties\\\"]/div[2]/e-sec-plus-minus/div/div[3]\"")
	 * private WebElement campoMaisQuantidade;
	 * 
	 * @FindBy(how = How.NAME, using = "save_to_cart") private WebElement
	 * campoAdcionarCarrinho;
	 */
